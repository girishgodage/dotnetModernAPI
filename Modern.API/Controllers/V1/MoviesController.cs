...
using Modern.ViewModel.Movies.Request;
using Newtonsoft.Json;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Modern.API.Controllers.V1
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public IActionResult CreateMovies(CreateMoviesRequest moviesRequest)
        {
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult UpdateMovie(CreateMoviesRequest moviesRequest, int? id)
        {
            var movie = _iMoviesQueries.GetMoviesbyId(id);
